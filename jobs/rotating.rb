...
SCHEDULER.every '15s' do
  ...
  gdun_data = Gdun.rotating_gdun(next_gdun)
  gdun = gdun_data[0]
  cust_name = gdun_data[1]
  cust_logo = gdun_data[2]
  next_gdun = gdun_data[3]
  installs_url = 'http://10.4.44.115:1337/csv/installreport/'+gdun.to_s
  sev1_url ='http://10.4.44.115:1337/csv/sev1report/'+gdun.to_s
  sr_url ='http://10.4.44.115:1337/csv/srreport/'+gdun.to_s 
